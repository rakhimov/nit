 ...
 */
#ifndef NIT_ENUM_CARD_DISTRIBUTION_H_
#define NIT_ENUM_CARD_DISTRIBUTION_H_
...
class CardDistribution {
 public:
   ...
   */
  virtual bool parse(
      const std::string& input);  //!< parses according to distribution type
...
#endif  // NIT_ENUM_CARD_DISTRIBUTION_H_
